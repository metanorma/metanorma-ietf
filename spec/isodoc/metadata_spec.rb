    ...
    output = <<~OUTPUT
      ...
      <uri>http://slate.example.com</uri>
       ...
       <author role='editor' initials='B. X.' surname='Rubble'>
        ...
        <address>
        <postal>
        <street ascii='6A Rubble Way'>6A Rubble Way</street>
      <city ascii='Bedrock'>Bedrock</city>
      <region ascii='CA'>CA</region>
      <country ascii='USA'>USA</country>
      <code ascii='90210'>90210</code>
        </postal>
        <phone>123c</phone>
