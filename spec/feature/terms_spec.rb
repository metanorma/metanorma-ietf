...
# WS3 port of spec/isodoc/terms_spec.rb: same inputs, the full
# default pipeline in place of IsoDoc::Ietf::RfcConvert
RSpec.describe "IETF terms rendering (WS3)" do
  it "processes IsoXML terms" do
    pending "metanorma-document 0.2.9 model gaps: termexample and " \
            "termnote coerce to empty paragraphs, origin locality and " \
            "deprecates content are dropped at parse — the transformer " \
            "cannot recover them (see qa-plan WS3 note)"
    input = <<~INPUT
